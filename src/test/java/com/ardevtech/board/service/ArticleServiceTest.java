...
class ArticleServiceTest {
    ...
    @Test
    void givenNoneExistentArticleId_whenSearchingArticleWithComments_thenThrowsException() {
        // Given
        Long articleId = 0L;
    ...
    @Test
    void givenNoneExistentArticleInfo_whenUpdatingArticle_thenLogWarningAndDoesNothing() {
        // Given
        ArticleDto dto = createArticleDto("new title", "new content");
    ...
    void givenModifiedArticleInfoWithDifferentUser_whenUpdatingArticle_thenDoesNothing() {
        ...
        Article defferentArticle = createArticle(differentArticleId);
        defferentArticle.setUserAccount(createUserAccount("John"));

        ArticleDto dto = createArticleDto("새 타이틀", "새 내용");

        given(articleRepository.getReferenceById(differentArticleId)).willReturn(defferentArticle);
        given(userAccountRepository.getReferenceById(dto.userAccountDto().userId())).willReturn(dto.userAccountDto().toEntity());
    ...
    private UserAccount createUserAccount() {
        return createUserAccount("ardev");
    }
    ...
    private HashtagDto createHashtag() {
