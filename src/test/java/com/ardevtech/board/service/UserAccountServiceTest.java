...
class UserAccountServiceTest {
    ...
    @DisplayName("회원 정보를 입력하면, 새로운 회원 정보를 저장하여 가입시키고 해다 회원 정보를 리턴한다.")
    @Test
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("ardev");
        UserAccount savedUserAccount = createSigningUpUserAccount("ardev");
